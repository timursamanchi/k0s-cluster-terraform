...
#######################################
resource "aws_security_group" "k0s_bastion_sg" {
...
resource "aws_security_group_rule" "bastion_ssh_in" {
  ...
  security_group_id = aws_security_group.k0s_bastion_sg.id
}
...
resource "aws_security_group_rule" "controller_ssh_in" {
  ...
  to_port                  = 22
  protocol                 = "tcp"
  source_security_group_id = aws_security_group.k0s_bastion_sg.id
  security_group_id        = aws_security_group.k0s_controller_sg.id
}
...
resource "aws_security_group_rule" "controller_worker_in" {
  ...
  to_port                  = 10250
  protocol                 = "tcp"
  source_security_group_id = aws_security_group.k0s_worker_sg.id
  security_group_id        = aws_security_group.k0s_controller_sg.id
}
...
#######################################
resource "aws_security_group" "k0s_worker_sg" {
...
resource "aws_security_group_rule" "worker_ssh_in" {
  ...
  protocol                 = "tcp"
  source_security_group_id = aws_security_group.k0s_bastion_sg.id
  security_group_id        = aws_security_group.k0s_worker_sg.id
}
